	...
	def __call__(self, *args, **kwargs):
		...
		if RENGINE_RECORD_ENABLED:
			if self.engine: # task not in engine.tasks, skip it.
				# create a rule for tasks that has to run parallel like nuclei
				# scan but not necessarily part of main task rather part like
				# nuclei scan being part of vulnerability task
				dependent_tasks = {
